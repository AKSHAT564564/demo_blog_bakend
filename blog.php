...
.sub-link{
  ...
  <!-- CSS Files -->
  <link href="cmb/css/bootstrap.min.css" rel="stylesheet">
  <link href="cmb/lib/icofont/icofont.min.css" rel="stylesheet">
  <link href="cmb/lib/slick/slick.css" rel="stylesheet">
  <link href="cmb/lib/slick/slick-theme.css" rel="stylesheet">
  <link href="cmb/lib/aos/aos.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="cmb/css/style.css" rel="stylesheet">
      ...
      <div class="col-md-6 col-lg-4 blog-list-outer">
        <div class="card card-color" >
          ...
          <div class="card-footer pt-0 border-0">
            <a href="javascript:void(0);" class="mt-auto read-more">Read More <i class="icofont-long-arrow-right"></i></a>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-4 blog-list-outer">
