...
! function(e) {
    ...
    jQuery.fn.megamenu = function(e) {
        function a() {
            if (i.find(".megamenu").each(function() {
                    var a, n = jQuery,
                        t = jQuery(this),
                        i = o.width(),
                        s = t.offset().left,
                        l = t.width(),
                        r = t.find("> .dropdown > li").length,
                        d = .7 * n("header").width(),
                        p = 1,
                        h = 0,
                        u = 1281 >= i ? 200 : 230;
                    t.find("> .dropdown > li.has-dropdown > .dropdown").each(function() {
                        var e = jQuery(this).find("> li").length;
                        e > p && (p = e, h = jQuery(this).parent("li").height())
                    }), t.find("> .dropdown > li.has-dropdown > .dropdown").each(function() {
                        var e = jQuery(this),
                            a = e.find("> li").length;
                        if (p > a)
                            for (var n = 1; p - a >= n; n++) e.append('<li class="empty-megamenu"><a>&nbsp</a></li>')
                    }), e = n("header .side").length ? i - n("header .side").width() : i, r = r * u > e && r > 4 ? 4 : r;
                    var a = r * u > e ? d + 30 : r * u + 30,
                        g = (i - a) / 2,
                        c = a / 2 - l / 2;
                    c = a / 2 > s + l / 2 - g ? e - (s + l) : c;
                    var m = i - s - l - g;
                    (i > 1300 || c > m) && (c = m), t.find("> .dropdown > li").css("width", u + "px"), t.find("> .dropdown").css({
                        width: a + "px"
                    })
                }), i.parents(".side").length) var a = i.find("li.megamenu > .dropdown");
            else var a = i.find("li:not(.megamenu).has-dropdown > .dropdown");
            a.each(function() {
                var e = t(this).parents("li:last"),
                    a = t(window).width(),
                    n = e.offset().left;
                e.width() + n > a && e.css({
                    left: "-100%",
        ...
        function n() {
            i.find(" li.has-dropdown").each(function() {
                var e, a, n = jQuery(this),
                    o = i.height(),
                    s = i.find("nav > ul > li.has-dropdown > a"),
                    l = 0;
                if (l = s.length > 1 ? jQuery(s.get(s.length - 1)).outerHeight(!0) + 20 : s.outerHeight(!0) + 20, !n.parents(".megamenu").length) {
                    if (jQuery(".top-classic").length) jQuery("header.top-classic .content").hasClass("style-wireframe") || jQuery(".top-classic nav > ul > li.has-dropdown > ul").css("top", l + (o - l) / 2 - 10);
                    else if (jQuery(".top-logotop").length) {
                        var r = jQuery("header.top-logotop .color-overlay").height(),
                            d = jQuery(".logo-top-container").outerHeight(!0) + jQuery(".logo").outerHeight(!0) + 5;
                        d > r && jQuery("header.top-logotop").css({
                            height: d
                        });
                        var p = d >= r ? 0 : (r - d) / 2;
                        l = jQuery("header .style-logotop nav > ul").height(), jQuery(".style-logotop  nav > ul > li.has-dropdown > ul").css("top", l + p - 10)
                    }
                    n.on("mouseenter tap", function(i) {
                        "tap" == i.type && i.stopPropagation(), clearTimeout(e), clearTimeout(a), e = setTimeout(function() {
                            if ((n.hasClass("megamenu") && n.parents(".side").length || n.parents(".gather-overlay").length || n.parents(".top").length) && (n.addClass("hippo-menu-hovered"), n.hasClass("hippo-menu-hovered")))
                                if (n.parents(".left.side-classic").length) {
                                    var e = jQuery("nav:not(.navigation-mobile) li.megamenu > ul > li");
                                    TweenMax.to(n.children("ul"), .4, {
                                        opacity: 1,
                                        marginLeft: 0,
                                        display: "block",
                                        ease: Expo.easeOut
                                    }), TweenMax.staggerTo(e, .9, {
                                        opacity: 1,
                                        marginLeft: 0,
                                        ease: Expo.easeOut,
                                        delay: 0
                                    }, .1)
                                } else if (n.parents(".right.side-classic").length) {
                                var e = jQuery("nav:not(.navigation-mobile) li.megamenu > ul > li");
                                TweenMax.to(n.children("ul"), .5, {
                                    opacity: "1",
                                    marginRight: 0,
                                    display: "block",
                                    ease: Expo.easeOut
                                ...
                                var e, a, i = t("#layoutcontainer > .layout").width(),
                                    o = n.offset().left - t("#layoutcontainer > .layout > .wrap").offset().left;
                                if (a = n.hasClass("megamenu") ? n.find("> .dropdown").width() : n.parent().hasClass("dropdown") ? n.width() + n.find("> .dropdown").width() : n.find("> .dropdown").width(), a + o > i && n.hasClass("megamenu")) {
                                    var s = 0,
                                        l = n.width(),
                                        r = (i - a) / 2,
                                        d = i - o,
                                        p = o + l;
                                    s = d >= a ? 0 : p >= a ? a - l : o - r, n.find("> .dropdown").css({
                                        left: -s
                                    })
                                }(a + o > i && !n.hasClass("megamenu") || n.parents(".open-right").length) && (n.find("> .dropdown").css({
                                    left: "-104.3%"
                                }), n.addClass("open-right")), n.hasClass("megamenu") ? (e = n.find("> ul > li"), n.parents(".content").hasClass("style-wireframe") ? TweenMax.to(n.children("ul"), .5, {
                                    opacity: "1",
                                    display: "block",
                                    marginTop: "3px",
                                    ease: Expo.easeOut
                                    ...
                                    marginTop: 0,
                                    ease: Expo.easeOut
                                }), TweenMax.staggerTo(e, .8, {
                                    opacity: 1,
                                    marginTop: 0,
                                    ease: Expo.easeOut,
                                    delay: 0
                                }, .15)) : n.parents(".content").hasClass("style-wireframe") ? TweenMax.to(n.children("ul"), .5, {
                                    opacity: "1",
                                    display: "block",
                                    marginTop: "3px",
                                    ease: Expo.easeOut
                        ...
                        clearTimeout(e), clearTimeout(a), a = setTimeout(function() {
                            if ((n.hasClass("megamenu") && n.parents(".side").length || n.parents(".gather-overlay").length || n.parents(".top").length) && (n.removeClass("hippo-menu-hovered"), !n.hasClass("hippo-menu-hovered")))
                                if (n.parents(".left.side-classic").length) {
                                    var e = jQuery("nav:not(.navigation-mobile) li.megamenu > ul > li");
                                    TweenMax.to(n.children("ul"), .3, {
                                        opacity: "0",
                                        display: "none",
                                        marginLeft: "-10px"
                                    }), TweenMax.set(e, {
                                ...
                                var e;
                                n.hasClass("megamenu") ? (e = n.find("> ul > li"), TweenMax.to(n.children("ul"), .2, {
                                    opacity: 0,
                                    display: "none",
                                    marginTop: "-10px"
                                }), TweenMax.to(e, 0, {
                        ...
                        if (xe ? o = Q(t, be, e, !0) : t.currentStyle && (o = t.currentStyle.filter.match(C), o = o && 4 === o.length ? [o[0].substr(4), Number(o[2].substr(4)), Number(o[1].substr(4)), o[3].substr(4), d.x || 0, d.y || 0].join(",") : ""), n = !o || "none" === o || "matrix(1, 0, 0, 1, 0, 0)" === o, d.svg = !!(Re && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM)), d.svg && (n && -1 !== (t.style[xe] + "").indexOf("matrix") && (o = t.style[xe], n = !1), De(t, Q(t, Pe, r, !1, "50% 50%") + "", d, t.getAttribute("data-svg-origin")), Te = a.useSVGTransformAttr || Ce, h = t.getAttribute("transform"), n && h && -1 !== h.indexOf("matrix") && (o = h, n = 0)), !n) {
                            ...
                            if (16 === h.length) {
                                ...
                                var V = h.length >= 6,
                                    ...
                                    Z = h[2] || 0,
                                    $ = V ? h[3] : 1;
                                d.x = h[4] || 0, d.y = h[5] || 0, p = Math.sqrt(G * G + W * W), f = Math.sqrt($ * $ + Z * Z), c = G || W ? Math.atan2(W, G) * I : d.rotation || 0, m = Z || $ ? Math.atan2(Z, $) * I + c : d.skewX || 0, Math.abs(m) > 90 && 270 > Math.abs(m) && (g ? (p *= -1, m += 0 >= c ? 180 : -180, c += 0 >= c ? 180 : -180) : (f *= -1, m += 0 >= m ? 180 : -180)), d.scaleX = p, d.scaleY = f, d.rotation = c, d.skewX = m, Se && (d.rotationX = d.rotationY = d.z = 0,
                                    d.perspective = w, d.scaleZ = 1), d.svg && (d.x -= d.xOrigin - (d.xOrigin * G - d.yOrigin * W), d.y -= d.yOrigin - (d.yOrigin * $ - d.xOrigin * Z))
                            }
                            d.zOrigin = T;
...
(function($) {
    $.fn.boostUpEach = function(callback) {
        var index = 0,
            t = this;
        boostEach(0);

        function boostEach(index) {
            if (!t.length || t.length == index) {
                return
            }
            callback.apply(t[index], [index]);
            setTimeout(function() {
                boostEach(index + 1)
            }, 0)
        }
        ...
        function r() {
            ...
            s.each(function() {
                ...
                var t = n(this),
                    r = t.offset().top,
                    h = c(t);
                u > r + h || r > u + e || s.css("backgroundPosition", o + " " + Math.round((f - u) * i) + "px")
            })
        }
        var c, f, s = n(this);
        setTimeout(function() {
            ...
            return n.height()
        }, (arguments.length < 1 || null === o) && (o = "50%"), (arguments.length < 2 || null === i) && (i = .1), (arguments.length < 3 || null === u) && (u = !0), t.bind("scroll", r).resize(r), setTimeout(function() {
            r()
        }, 1e3)
    }
}(jQuery);